...
# Java SDK for the FINBOURNE Identity Service API
...
This is the java SDK for the FINBOURNE Identity Service API, part of the [LUSID by FINBOURNE](https://www.finbourne.com/lusid-technology) platform. To use it you'll need a LUSID account - [sign up for free at lusid.com](https://www.lusid.com/app/signup).
...
```groovy
  ...
  dependencies {
     implementation "com.finbourne:identity-sdk:2.0.192"
  }
```
