...
*AuthenticationApi* | [**getSessionPolicy**](docs/AuthenticationApi.md#getsessionpolicy) | **GET** /api/authentication/session-policy | GetSessionPolicy: Get session policy
...
*AuthenticationApi* | [**updateSessionPolicy**](docs/AuthenticationApi.md#updatesessionpolicy) | **PUT** /api/authentication/session-policy | UpdateSessionPolicy: Update session policy
