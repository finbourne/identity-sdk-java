...
/**
* Utility class that builds pre-configured lusidIdentity API instances to access lusidIdentity.
*
*/
public class ApiFactory {
    ...
    /**
    * The unique package that hosts all the lusidIdentity API classes
    */
    public static final String API_PACKAGE = "com.finbourne.lusid-identity.api";
    ...
    */
    ...
    /**
    * Builds an instance of a lusidIdentity API 
    *
    * For each instance of an {@link ApiFactory} only a singleton instance of each lusidIdentity API class exist. The APIs
    * are lazily initialised on request.
    *
    *
    * @param apiClass - class of the lusidIdentity API to create
    * @param <T> lusidIdentity API type
    * @return instance of the lusidIdentity API type configured as per the {@link ApiClient}
    *
    * @throws UnsupportedOperationException is the apiClass does not belong to the import com.finbourne.lusid-identity.api package or
    ...
    */
    ...
    /*
    * Create an instance of a lusidIdentity API configured by an {@link ApiClient}
    *
    * @throws UnsupportedOperationException on any reflection related issues on constructing the lusidIdentity API object
    */
    ...
    /*
    * Retrieves the constructor for the lusidIdentity API that accepts an {@link ApiClient}
    *
    * @throws UnsupportedOperationException if the class doesn't have a valid constructor that takes
    * an {@link ApiClient} as an argument to ensure proper construction of a lusidIdentity API instance.
    */
    ...
    /*
    * Checks the class lives in the set package for lusidIdentity API classes.
    *
    * @throws UnsupportedOperationException if API class does not live in lusidIdentity API package
    */
